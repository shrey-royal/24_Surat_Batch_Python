...
# print(fruits, prime_numbers, sep='\n')
...
#----------------------------------------------------------
# print(indian_veggies.count("Tomato (Tamatar)"))
...
# indian_veggies.insert(38, "Bell Pepper (Capsicum)")
#
# print(indian_veggies)

# print(indian_veggies.index("Turnip (Shalgam)", 10))
#----------------------------------------------------------
